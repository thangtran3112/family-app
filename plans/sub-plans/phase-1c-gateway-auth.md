...
### Auth Service (`backend/app/api/v1/auth_verify.py`)
...
- [ ] Create `backend/app/api/v1/auth_verify.py` with `/auth/verify` endpoint
...
- [ ] Create `backend/app/core/gateway_auth.py`:
  ```python
