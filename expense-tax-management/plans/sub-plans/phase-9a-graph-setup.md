...
### 2. Native Graphiti Integration (`expense-service/app/services/graphiti.py`)

- [ ] Add dependencies to `expense-service/pyproject.toml`:
...
### 3. FastAPI Graph Query Endpoints (`expense-service/app/api/v1/graph.py`)
