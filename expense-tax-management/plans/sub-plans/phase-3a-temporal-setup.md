...
### 2. Temporal Python Worker Setup (`expense-service/workers/`)

- [ ] Add `temporalio>=1.8.0` to `expense-service/pyproject.toml`
- [ ] Create worker entrypoint `expense-service/workers/worker.py`:
...
### 3. Expense Processing Workflow (`expense-service/workers/workflows/expense.py`)
...
### 4. Activities Implementation (`expense-service/workers/activities/`)
