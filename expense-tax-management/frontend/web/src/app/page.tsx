        ...
        <section className="bg-gradient-to-b from-zinc-900 to-zinc-900/60 border border-zinc-800/80 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
          ...
          <div className="max-w-xl space-y-3">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Snap a receipt with your phone camera. Our Python expense service extracts structured line items, computes tax attribution, and links to your temporal knowledge graph.
            </p>
          </div>
